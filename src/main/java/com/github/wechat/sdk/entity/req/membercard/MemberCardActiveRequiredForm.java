...
@Data
@NoArgsConstructor
public class MemberCardActiveRequiredForm implements Serializable {

    private static final long serialVersionUID = -8146536551406527700L;
    ...
    private List<FormInput> commonFieldIdList = Arrays.asList(FormInput.USER_FORM_INFO_FLAG_NAME, FormInput.USER_FORM_INFO_FLAG_MOBILE);
